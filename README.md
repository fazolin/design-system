...
## como passar pra um agente de IA novo

cola o bloco abaixo no início da conversa com qualquer agente (Claude Code, Claude.ai, ChatGPT, Cursor, Copilot Chat). funciona em qualquer agente com acesso à web — ele vai puxar o CLAUDE.md e seguir as regras pelo resto da sessão.
...
a última linha é diagnóstica: se o agente não consegue fetchar a URL, ele vai dizer alguma coisa genérica ou inventar — aí você sabe que precisa colar o conteúdo do CLAUDE.md manualmente.

### variante curta

quando já estiver no meio de uma conversa e quiser puxar contexto rápido:
...
Claude Code lê o CLAUDE.md local em toda sessão automaticamente, então isso garante que toda sessão começa com o design-system carregado.
